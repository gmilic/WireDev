  ...
  currentImportMethodElement[i].addEventListener('click', function (e) {
    if (document.getElementById('OceanFreight').checked) {
      ...
      document.getElementById('calc-green-box_ocean-group').style.display =
        'block'
      document.getElementById('airFreight-group').style.display = 'none'
      document.getElementById('typical-container-size').style.display = 'block'
      ...
      document.getElementById('typical-container-size').style.display = 'none'
...
const seeMyResult = document.getElementById('CalcNext4')
...
seeMyResult.addEventListener('click', function (e) {
  e.preventDefault
...
calcBack5Button.addEventListener('click', function (e) {
  e.preventDefault
  step05.classList.add('hidden-section')
  step01.classList.remove('hidden-section')
  step01.classList.add('show-section')
...
const averageCostUnitWrap = document.getElementById('average-cost-unit-wrap')
const warehouseFeeUnitTitle = document.getElementById(
  'warehouse-fee-unit-title'
)
const warehouseFeeUnitSlider = document.getElementById(
  'warehouse-fee-unit-slider'
)
...
unitTypeElement.addEventListener('change', function (e) {
  if (unitTypeElement.value === 'imperial') {
    ...
    averageCostUnitWrap.innerHTML = 'lib '
    warehouseFeeUnitTitle.innerHTML = 'foot'
    warehouseFeeUnitSlider.innerHTML = '/cu.ft.'
    ...
    averageCostUnitWrap.innerHTML = 'kilo '
    warehouseFeeUnitTitle.innerHTML = 'meter'
    warehouseFeeUnitSlider.innerHTML = '/cu.meter'
  } else {
  }
})
...
calcSubmitMainButton.addEventListener('click', function (e) {
  ...
  let dataCalculations = {
    ...
    importerSecurityFilingBondCalculated: importerSecurityFilingBondCalculated,
  ...
  messageHSContent += 'Max Units Per Container: ' + maxUnitsPerContainer + '\\n'
  messageHSContent += 'Ocean Freight: ' + oceanFreight + '\\n'
  messageHSContent += 'Air Freight Calculated: ' + airFreightCalculated + '\\n'
  messageHSContent +=
  ...
  messageHSContent +=
    'Inland Fuel Surcharge Calculated: ' + inlandFuelSurchargeCalculated + '\\n'
