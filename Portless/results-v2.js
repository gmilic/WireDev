...
for (let key in dataCalculations) {
  dataCalculations[key] = (
    Math.round((parseFloat(dataCalculations[key]) + Number.EPSILON) * 100) / 100
  ).toFixed(2)
}
...
let calcDetails = `
        ...
        <tr class="tableFirstRow"><td>Product Cost</td><td></td><td class="price main-table_2nd-column">${curency}${costPerUnit}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  costPerUnit
)}</td></tr>
  <tbody id="table-section_FreightCosts">
        <tr><td rowspan="12">Freight Costs</td><td>Ocean Freight (Container Cost)</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.oceanFreight
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.oceanFreight
)}</td></tr>
        <tr><td>Importer Security Filing & Bond</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.importerSecurityFilingBondCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.importerSecurityFilingBondCalculated
)}</td></tr>
        <tr><td>Handling Fee</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.handlingFeeCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.handlingFeeCalculated
)}</td></tr>
        <tr><td>Drayage</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.drayageCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.drayageCalculated
)}</td></tr>
        <tr><td>Chassis</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.chassisCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.chassisCalculated
)}</td></tr>
        <tr><td>Congestion Fee</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.congestionFeeCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.congestionFeeCalculated
)}</td></tr>
        <tr><td>Security Surcharge</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.securitySurchargeCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.securitySurchargeCalculated
)}</td></tr>
        <tr><td>Inland Fuel Surcharge</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.inlandFuelSurchargeCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.inlandFuelSurchargeCalculated
)}</td></tr>
        <tr><td>Hazmat</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.hazmatCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.hazmatCalculated
)}</td></tr>
        <tr><td>Delivery</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.deliveryCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.deliveryCalculated
)}</td></tr>
        <tr><td>Detention Fee</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.detentionFeeCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.detentionFeeCalculated
)}</td></tr>
        <tr><td>Pre-Pull</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.prePullCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.prePullCalculated
)}</td></tr>
  </tbody>
        <tr id="table-section_Airfreight"><td>Air Freight</td><td></td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.airFreightCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.airFreightCalculated
)}</td></tr>
        <tr><td rowspan=${tableRowCustomCost}>Customs Costs</td><td>Customs / Tariff Fee</td><td class="price main-table_2nd-column">${lessThan001(
  dataCalculations.customsTarifRate
)}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.customsTarifRate
)}</td></tr >
        <tr id="table-section_CustomClearance"><td>Custom Clearance</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.customsClearanceCalculated
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.customsClearanceCalculated
)}</td></tr>
        <tr><td rowspan="6">3PL / Shipping Fees</td><td>Monthly Account Fee</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.monthlyAccountFee
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.monthlyAccountFee
)}</td></tr>
        <tr><td>Receiving / Inbound Fee</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.receivingInboundFee
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.receivingInboundFee
)}</td></tr>
        <tr><td>Storage / Warehousing Fee</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.storageWarehouseFee
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.storageWarehouseFee
)}</td></tr>
        <tr><td>Pick & Pack Fee</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.pickPackPerOrder
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.pickPackPerOrder
)}</td></tr>
        <tr><td>Material Fees</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.materiialsFeePerOrder
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.materiialsFeePerOrder
)}</td></tr>
        <tr><td>Shipping Cost</td><td class="price main-table_2nd-column">${lessThan001(
          dataCalculations.averageShippingCostPerOrder
        )}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.averageShippingCostPerOrder
)}</td></tr>
        <tr><td rowspan=${tableRowIndirectCostSpan}>Indirect Costs</td><td>Inventory Financing Cost</td><td class="price main-table_2nd-column">${lessThan001(
  dataCalculations.inventoryFinancingCost
)}</td><td class="price main-table_3nd-column">${percentInGrandTotal(
  dataCalculations.inventoryFinancingCost
)}</td></tr>
        <tr id="table-section_OverstockCost"><td>Overstock Cost</td><td class="price main-table_2nd-column">${lessThan001(
...
calcTableFreight.innerHTML = `
        ...
        <tr class="total"><td><strong>Total freight cost per unit</strong></td><td class="price"><strong>${curency}${roundToTwoDecimalPlaces(
  freightTotal
)}</strong></td></tr>
        </table>
        `
...
calcTable3pl.innerHTML = `
        ...
        <tr class="total"><td><strong>Total 3PL cost per unit</strong></td><td class="price"><strong>${curency}${roundToTwoDecimalPlaces(
  table3plTotal
)}</strong></td></tr>
          </table>
        `
...
if (dataInputs.containerSize === 'LCL') {
  document.getElementById('table-section_OverstockCost').style.display = 'none'
}
...
document.getElementById('cost-over').innerHTML =
  'over ' + curency + Math.floor(totalPrice).toLocaleString()
